# React Frontend Architecture Playbook

**Version:** 2.0
**Last Updated:** January 2026
**Audience:** Frontend Engineering Team
**Related Documents:** [APP_QUICKSTART.md](APP_QUICKSTART.md), [INFRASTRUCTURE.md](INFRASTRUCTURE.md), [GITHUB_ACTIONS.md](GITHUB_ACTIONS.md)

---

## Purpose

This document establishes our standard React frontend architecture. It is opinionated by design—consistency across projects enables us to move fast, onboard quickly, and maintain high quality regardless of which client engagement we're on.

These are defaults, not constraints. Deviate when you have a good reason and document it in an ADR.
