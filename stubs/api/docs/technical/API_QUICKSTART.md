...
**Related Documents:** [FASTAPI_PROJECT_STANDARDS.md](FASTAPI_PROJECT_STANDARDS.md), [API_SPECIFICATION.md](API_SPECIFICATION.md), [DATABASE_SCHEMA.md](DATABASE_SCHEMA.md)
...
### Exporting OpenAPI Spec for Postman

FastAPI automatically generates an OpenAPI 3.0 specification. To import into Postman:
...
Then import `openapi.json` into Postman via **Import** > **File**.

**Option 3: Generate Static Spec (without running server)**
```bash
...
After importing, Postman creates a collection with all endpoints, request schemas, and example payloads.
...
- [FastAPI Project Standards](./FASTAPI_PROJECT_STANDARDS.md) - Folder structure, CLI patterns, conventions
- [API Specification](./API_SPECIFICATION.md) - REST API endpoints and schemas
- [Database Schema](./DATABASE_SCHEMA.md) - Data model and migrations
- [Infrastructure](./INFRASTRUCTURE.md) - AWS deployment (ECS, RDS, Redis)
