...
This guide covers everything developers need to know to contribute to Connect 2.0. It consolidates the development workflow, quality standards, and documentation requirements across all services (API, Web, and shared infrastructure).
...
Connect 2.0 uses a **polyglot repository** pattern with shared infrastructure:
...
│   ├── infrastructure/           # API-specific Terraform and Docker
│   └── .github/                  # API-specific workflows
│
├── web/                          # React frontend application
│   ├── src/                      # Application code
│   ├── docs/                     # Web-specific documentation
│   ├── infrastructure/           # Web-specific Terraform and Docker
│   └── .github/                  # Web-specific workflows
│
├── docs/                         # Overarching documentation (this location)
...
└── infrastructure/               # SHARED infrastructure modules
    └── terraform/modules/        # VPC, ECS cluster, Route53, etc.
```
...
1. Determine if shared or per-service
2. Create/update Terraform module in appropriate location:
   - Shared: `infrastructure/terraform/modules/`
   - API-specific: `stubs/api/infrastructure/terraform/modules/`
   - Web-specific: `stubs/web/infrastructure/terraform/modules/`
