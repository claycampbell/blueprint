...
#### UPDATED November 15, 2025 - Reflects revised user count (65 internal + ~150 external users)
...
### REVISED USER COUNT ASSUMPTIONS (November 15, 2025)
...
#### REVISED Year 1 Assumptions (215 users, 40-50 concurrent)
...
#### REVISED Year 1 Assumptions (40-50 concurrent users, ~100 DB connections)
...
| **VM Snapshots** | $0.05/GB/mo x 200GB = $10/mo | EBS Snapshots: $0.05/GB x 200GB = $10/mo | Persistent Disk Snapshots: $0.026/GB x 200GB = $5/mo |
...
#### REVISED Year 1 Estimates (215 users, 40-50 concurrent)
...
| **Estimated Volume** | 2,000 docs/month x 5 pages avg = 10,000 pages/month | Same | Same | Per PRD usage |
...
| **Estimated Volume** | 20M input + 2M output tokens/month | Same | Same | ~2,000 docs x 10K tokens each |
...
|-----------|----------|---------------|---------------|
| **Model Training** | $0.60/hour x 10 hours/month = $6/mo | $0.50/hour x 10 hours = $5/mo | $0.55/hour x 10 hours = $5.50/mo |
| **Model Hosting** | $50/mo (1 endpoint, low traffic) | $45/mo | $48/mo |
| **Inference** | $0.10/1,000 predictions x 100K/month = $10/mo | Same | Same |
...
| **Pricing** | $0.0079/SMS (US) x 5K = $40/mo | $0.0075/SMS x 5K = $38/mo | $0.0075/SMS x 5K = $38/mo | Standard US rates |
| **ANNUAL** | **$480** | **$456** | **$456** | |
...
|---------|----------|-----------|------------|-------|
| **Plan** | Standard ($25/user/mo x 3 users) | Essentials ($15/mo unlimited) | Small Business ($30/user/mo) | Based on servicing team needs |
...
|---------|-------------------|---------|-----------|----------|
| **Plan** | Pay-as-you-go | Pro ($31/host/mo x 3 hosts) | Standard ($99/mo) | APM + infrastructure monitoring |
| **Data Ingestion** | $2.30/GB x 50GB/mo = $115/mo | Included up to 150GB | Included up to 100GB | Logs, metrics, traces |
...
|---------|----------------|-----------|----------|
| **Plan** | Team ($4/user/mo x 5 devs) | Premium ($29/user/mo) | Performance ($70/mo) |
...
- Azure DevOps: $6/user/mo x 5 = $30/month ($360/year)
...
|---------|------|--------|------------|
| **Plan** | Standard ($7.75/user/mo x 25 users) | Plus ($8/user/mo) | Standard ($10/user/mo) |
...
| Tool | Cost | Purpose |
|------|------|---------|
| **GitHub Team** | $4/user/mo x 5 devs = $240/year | Source control |
| **VS Code** | Free | IDE |
| **Postman Team** | $12/user/mo x 3 = $432/year | API testing |
| **Figma Professional** | $12/editor/mo x 2 = $288/year | UX/UI design |
...
#### REVISED Year 1 Estimates (215 users: 65 internal + 150 external)
...
Tenant Variable Cost =
  (Tenant Documents x AI Cost per Doc) +
  (Tenant Storage GB x Storage Cost per GB) +
  (Tenant Compute Hours x Compute Cost per Hour) +
  (Tenant Email/SMS x Messaging Cost per Message)
```
...
Variable:
  - AI: 2,000 docs x 12 months x $0.021 = $504
  - Storage: 150GB x $2.40/GB = $360
...
Fixed Share: $4,000
Variable:
  - AI: 400 x 12 x $0.021 = $101
  - Storage: 30GB x $2.40/GB = $72
...
4. **User count significantly impacts costs:** Revised estimate of 215 users (vs. 25) increases Year 1 costs by 36-40%
